...
UPDATER_PATH = Path(__file__).resolve().parents[1] / "scripts" / "update_02109_tool.py"
SPEC = importlib.util.spec_from_file_location("update_02109_tool", UPDATER_PATH)
