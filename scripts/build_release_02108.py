#!/usr/bin/env python3
"""Build the checksum-verified AFI-OS 0.2.108 update package."""
...
FILES = (
    "README.md",
    "ROLLBACK-AFI-OS-0.2.108.command",
    "SETUP-LLM.command",
    ...
    "apps/web/styles.css",
    "docs/CHANGELOG.md",
    "docs/README-FIRST-0.2.108.txt",
    "docs/RUNBOOK.md",
    "docs/TASKBOARD.md",
    "docs/TEST_REPORT.md",
    "pyproject.toml",
    "migrations/versions/6b1d8e2c4108_camp_doctor.py",
    "migrations/versions/71e4a2b890c3_terms_vietnamese.py",
    "scripts/update_02108_tool.py",
    "src/afi_os/__init__.py",
    "src/afi_os/api/__init__.py",
    "src/afi_os/api/campaigns.py",
    "src/afi_os/api/programs.py",
    ...
    "tests/test_camp_doctor_02108.py",
    "tests/test_campaign_diagnosis_02108.py",
    "tests/test_evidence_pack_0262.py",
    "tests/test_exposure_022.py",
    "tests/test_llm_extractor_02107.py",
    "tests/test_llm_terms_02107.py",
    "tests/test_sprint1.py",
    "tests/test_terms_research_visibility_0249.py",
    "tests/test_terms_vietnamese_02108.py",
    "tests/test_update_02108.py",
    "uv.lock",
)
...
def main() -> None:
    ...
    manifest = {
        ...
        "allowed_from_versions": ["0.2.107"],
        "expected_migration_head": "71e4a2b890c3",
        "files": entries,
    }
    ...
    shutil.copy2(ROOT / "UPDATE-AFI-OS-0.2.108.command", OUTPUT)
    shutil.copy2(ROOT / "scripts/update_02108_tool.py", OUTPUT / "update_02108_tool.py")
    shutil.copy2(ROOT / "docs/README-FIRST-0.2.108.txt", OUTPUT / "README-FIRST.txt")
    checksum_paths = (
    ...
    (OUTPUT / "AFI-OS-update-0.2.108.sha256").write_text(
        checksum_text,
        encoding="utf-8",
    )
