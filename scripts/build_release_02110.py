#!/usr/bin/env python3
"""Build the checksum-verified AFI-OS 0.2.110 update package."""
...
FILES = (
    "README.md",
    "ROLLBACK-AFI-OS-0.2.110.command",
    "SETUP-LLM.command",
    "SETUP-TRAFFIC-DATA.command",
    "apps/web/index.html",
    "docs/CHANGELOG.md",
    "docs/MASTER_SPEC.md",
    "docs/README-FIRST-0.2.110.txt",
    "docs/RUNBOOK.md",
    "docs/TASKBOARD.md",
    "docs/TEST_REPORT.md",
    "pyproject.toml",
...
def main() -> None:
    ...
    manifest = {
        ...
        "allowed_from_versions": ["0.2.109", "0.2.110"],
    ...
    shutil.copy2(ROOT / "UPDATE-AFI-OS-0.2.110.command", OUTPUT)
    shutil.copy2(ROOT / "scripts/update_02110_tool.py", OUTPUT)
    shutil.copy2(ROOT / "docs/README-FIRST-0.2.110.txt", OUTPUT / "README-FIRST.txt")
    checksum_paths = (
    ...
    (OUTPUT / "AFI-OS-update-0.2.110.sha256").write_text(
        checksum_text,
        encoding="utf-8",
    )
