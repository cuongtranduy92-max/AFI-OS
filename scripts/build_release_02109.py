#!/usr/bin/env python3
"""Build the checksum-verified AFI-OS 0.2.109 update package."""
...
FILES = (
    "README.md",
    "ROLLBACK-AFI-OS-0.2.109.command",
    "SETUP-LLM.command",
    ...
    "apps/web/styles.css",
    "docs/CHANGELOG.md",
    "docs/README-FIRST-0.2.109.txt",
    "docs/RUNBOOK.md",
    "docs/TASKBOARD.md",
    "docs/TEST_REPORT.md",
    "pyproject.toml",
    "uv.lock",
    "migrations/versions/82c6d4f1a9b7_progressive_appraisal_jobs.py",
    "scripts/update_02109_tool.py",
...
def main() -> None:
    ...
    manifest = {
        ...
        "allowed_from_versions": ["0.2.108", "0.2.109"],
    ...
    shutil.copy2(ROOT / "UPDATE-AFI-OS-0.2.109.command", OUTPUT)
    shutil.copy2(ROOT / "scripts/update_02109_tool.py", OUTPUT)
    shutil.copy2(ROOT / "docs/README-FIRST-0.2.109.txt", OUTPUT / "README-FIRST.txt")
    checksum_paths = (
    ...
    (OUTPUT / "AFI-OS-update-0.2.109.sha256").write_text(
        checksum_text,
        encoding="utf-8",
    )
